...
const INTEREST_DEPT_MAP: Record<string, string[]> = {
  ...
  // ── Specific interest mappings (added with granular interest list) ────────
  "Anatomy": ["BIO", "NUR", "HHP", "CHM"],
  "Cell Biology": ["BIO", "CHM", "MAT"],
  "Ecology": ["BIO", "SENS", "ANR", "GEO"],
  "Evolutionary Biology": ["BIO", "SENS", "ANR"],
  "Genetics": ["BIO", "CHM", "MAT", "SENS"],
  "Immunology": ["BIO", "CHM", "NUR", "HLT"],
  "Physiology": ["BIO", "NUR", "HHP", "CHM"],
  "Wildlife Biology": ["BIO", "ANR", "SENS", "GEO"],
  "Conservation Biology": ["BIO", "SENS", "ANR", "GEO"],
  "Ecological Restoration": ["SENS", "BIO", "ANR", "GEO"],
  "Machine Learning": ["CSC", "MAT", "PHY"],
  "Data Analytics": ["CSC", "MAT", "ECO", "BUS"],
  "Software Architecture": ["CSC", "MAT", "PHY"],
  "Embedded Systems": ["CSC", "PHY", "ETAD", "MAT"],
  "Information Systems": ["CSC", "BUS", "MAT", "ECO"],
  "3D Printing": ["ETAD", "PHY", "ART", "CSC"],
  "Electrical Engineering": ["PHY", "ETAD", "MAT", "CSC"],
  "Mechanical Design": ["PHY", "ETAD", "MAT", "CHM"],
  "Mechatronics": ["PHY", "ETAD", "MAT", "CSC"],
  "Structural Engineering": ["PHY", "ETAD", "MAT", "GEO"],
  "Renewable Energy Systems": ["PHY", "ETAD", "CHM", "SENS"],
  "Product Design": ["ART", "ETAD", "CSC", "COM"],
  "Industrial Design": ["ART", "ETAD", "PHY", "COM"],
  "Fashion Design": ["ART", "CFS", "ETAD"],
  "Behavioral Science": ["PSY", "SOC", "BIO", "CFS"],
  "Forensic Psychology": ["PSY", "SOC", "PSJ", "BIO"],
  "Social Psychology": ["PSY", "SOC", "CFS", "PHI"],
  "Gerontology": ["PSY", "SOC", "CFS", "HLT", "NUR"],
  "Mental Health": ["PSY", "SOC", "NUR", "HLT", "CFS"],
  "Sports Medicine": ["HHP", "BIO", "NUR", "PSY"],
  "Physical Therapy": ["HHP", "BIO", "NUR", "PSY"],
  "Actuarial Science": ["MAT", "ECO", "BUS", "CSC"],
  "Financial Modeling": ["BUS", "ECO", "MAT", "CSC"],
  "Marketing Strategy": ["BUS", "COM", "PSY", "ECO"],
  "Operations Management": ["BUS", "ECO", "MAT", "CSC"],
  "Human Resources": ["BUS", "PSY", "SOC", "COM"],
  "Athletic Coaching": ["HHP", "PSY", "EDS", "BIO"],
  "Culinary Arts": ["ANR", "BIO", "CFS", "HLT"],
